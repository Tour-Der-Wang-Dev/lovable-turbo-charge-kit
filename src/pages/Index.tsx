...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Lovable Studio - AI-Powered Productivity Platform</title>
        <meta name="description" content="Enhance your workflow with AI-powered tools designed to streamline productivity and boost creativity with voice input, project management, and SEO tools." />
        <meta name="keywords" content="AI productivity, voice-to-text, project management, SEO tools, prompt library" />
      </Helmet>
